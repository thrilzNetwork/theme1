    ...
    <section className="relative min-h-screen flex flex-col items-center pt-32 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none flex items-center justify-center">
        <div className="relative w-[1000px] h-[1000px]">
          <div className="absolute inset-0 bg-radial-gradient from-[#22D0DF]/10 to-transparent rounded-full blur-[120px] animate-pulse" />
          <div className="absolute inset-0 border border-[#22D0DF]/5 rounded-full scale-110 animate-[spin_60s_linear_infinite]" />
          <div className="absolute inset-0 border border-[#22D0DF]/5 rounded-full scale-125 animate-[spin_90s_linear_infinite_reverse]" />
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        <motion.a 
          ...
          className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full border border-[#22D0DF]/20 bg-[#22D0DF]/5 text-[#22D0DF] text-xs font-medium mb-12 hover:bg-[#22D0DF]/10 transition-all group"
        >
          <div className="relative flex items-center justify-center">
            <Bell size={14} className="relative z-10" />
            <span className="absolute inset-0 bg-[#22D0DF] rounded-full animate-ping opacity-20" />
          </div>
        ...
        <motion.h1 
          ...
          className="text-6xl md:text-[88px] font-semibold tracking-tight leading-[1.05] mb-10"
        >
      ...
      {/* Clients Section */}
      <div className="mt-auto pb-20 w-full max-w-7xl mx-auto px-6">
